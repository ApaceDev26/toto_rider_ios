...
class _LocationCardWidgetState extends State<LocationCardWidget> {
  ...
  double? _riderToRestaurantDistance;
  double? _restaurantToCustomerDistance;
  ...
  Future<void> _loadDistances() async {
    ...
    final riderDistance =
        await addressController.getRoadDistanceToRider(restaurantLatLng);

    double? customerDistance = widget.orderModel.distance;
    if (customerDistance == null &&
        widget.orderModel.deliveryAddress?.latitude != null &&
        widget.orderModel.deliveryAddress?.longitude != null) {
      customerDistance = await addressController.getRoadDistanceKm(
        restaurantLatLng,
        LatLng(
    ...
    setState(() {
      _riderToRestaurantDistance = riderDistance;
      _restaurantToCustomerDistance = customerDistance;
    });
  }
  ...
  String _formatDistance(double? distance) {
    ...
    return '${distance > 1000 ? '1000+' : distance.toStringAsFixed(2)} ${'km'.tr} ';
  }

  @override
  Widget build(BuildContext context) {
    final restaurantDistance = _riderToRestaurantDistance;
    final restaurantToCustomerDistance = _restaurantToCustomerDistance;
                                  ...
                                  children: [
                                    Row(children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          _formatDistance(restaurantDistance),
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                              ...
                              Row(children: [
                                ...
                                Container(
                                  ...
                                  padding: const EdgeInsets.all(
                                      Dimensions.paddingSizeExtraSmall),
                                  child: Text(
                                    _formatDistance(restaurantToCustomerDistance),
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                    style: robotoBold.copyWith(
                                        fontSize: Dimensions.fontSizeSmall),
