...
import 'package:toto_rider/feature/auth/widgets/additional_data_section_widget.dart';
import 'package:toto_rider/feature/forgot_password/widgets/pass_view_widget.dart';
import 'package:toto_rider/helper/custom_validator.dart';
...
import 'package:toto_rider/common/widgets/custom_dropdown_widget.dart';
import 'package:toto_rider/common/widgets/custom_text_field_widget.dart';
import 'package:toto_rider/common/widgets/custom_snackbar_widget.dart';
import 'package:toto_rider/common/models/config_model.dart';
import 'package:toto_rider/feature/auth/domain/models/delivery_man_body_model.dart';
                                              ...
                                              child: Text(
                                                () {
                                                  ...
                                                  if (vehicleIdx == null ||
                                                      ...
                                                      vehicleIdx >
                                                          vehicles.length) {
                                                    return 'select_vehicle'.tr;
                                                  }
                                                  return vehicles[vehicleIdx - 1]
                                                      .type!
                                                      .tr;
                                                }(),
                                                style: robotoRegular.copyWith(
